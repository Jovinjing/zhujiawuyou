  ...
  <div>
    ...
    <div class="card" style="margin-bottom: 5px">
      <el-table stripe :data="data.tableData" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="picture" label="评论的图片">
        ...
        <el-table-column prop="commentTime" label="评论时间"/>
          <el-table-column prop="commentDescribe" label="评论描述"/>
    ...
    <el-dialog title="用户信息" v-model="data.formVisible" width="40%" destroy-on-close>
      <el-form ref="form" :model="data.form" label-width="70px" style="padding: 20px">
        ...
        <el-form-item prop="commentDescribe" label="评论描述">
          <el-input v-model="data.form.commentDescribe" placeholder="请输入电话"></el-input>
        </el-form-item>
      </el-form>
      <template #footer>
...
const load = () => {
  request.post('/Comment/selectPage?pageNum='+data.pageNum+'&pageSize='+data.pageSize, {
    userName:data.name
  }).then(res => {
